...
MODULE_SOURCES = {
    ...
    # `depletion`: on-hand is the last count minus depletion since, so a
    # depletion sync that stopped overstates stock silently (DH2-4).
    "inventory": ("inventory", "pos", "sales", "depletion"),
    "food": ("inventory", "pos", "sales", "depletion"),
    "food_cost": ("inventory", "pos", "sales", "depletion"),
