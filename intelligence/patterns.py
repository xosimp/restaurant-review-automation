...
HYPOTHESES = (
    ...
    {"key": "specials_engagement", "behaviour": ("specials_28d", ">=", 2), "outcome": "campaign_tap_rate_28d",
     "better": "higher", "unit": "share",
     "sentence": "those rotating specials at least every two weeks saw {effect_pct:.0f} points {direction} tap rates on their texts",
     "rec_kinds": ("draft_campaign", "post", "special", "marketing")},
