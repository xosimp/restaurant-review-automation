...
PROFILE / ICONS
  x-twitter-profile-400x400.png           X (Twitter) profile photo — 400x400
  facebook-profile-720x720.png            Facebook Page profile picture — shown at 170, upload 720
  instagram-profile-1080x1080.png         Instagram profile — shown at 320, upload 1080
  linkedin-company-logo-400x400.png       LinkedIn company page logo — 400x400 (min 300)
  youtube-profile-800x800.png             YouTube channel picture — 800x800
  google-business-profile-logo-720x720.png Google Business Profile logo — 720x720 (min 250)
  google-cloud-oauth-app-logo-120x120.png Google Cloud OAuth consent-screen app logo — exactly 120x120
  meta-developer-app-icon-1024x1024.png   Meta for Developers app icon — 1024x1024
  stripe-icon-512x512.png                 Stripe branding icon (checkout/portal) — square 512
  generic-avatar-512x512.png              Slack, Notion, Apple Business, Calendly, etc.
  web-manifest-icon-192x192.png / 512     PWA / web app manifest icons
  app-store-icon-1024x1024.png            App Store Connect icon (same art the app ships with)
...
lockup-light/dark, appicon-source.

Palette: Ember #D4583A · Ember2 #E8956A · Ink #F0EBE0 · Obsidian #2C2C2E→#161618 · Paper #0C0C0C
Type: Clash Display (headlines/wordmark) · Apfel Grotezk (body) · Space Grotesk (numbers, the AI tag)
