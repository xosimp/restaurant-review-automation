...
<div class="price">
  ...
  <table>
    <tr><th>Modules</th><th>Setup, one-time</th><th>Monthly</th><th>Annual, per month</th></tr>
    <tr><td>1 module</td><td><span class="num">$750</span></td><td><span class="num">$349</span><small>/mo</small></td><td><span class="num">$299</span><small>/mo</small></td></tr>
    <tr><td>2 modules</td><td><span class="num">$1,500</span></td><td><span class="num">$649</span><small>/mo</small></td><td><span class="num">$549</span><small>/mo</small></td></tr>
    <tr><td>3 modules</td><td><span class="num">$2,250</span></td><td><span class="num">$899</span><small>/mo</small></td><td><span class="num">$749</span><small>/mo</small></td></tr>
    <tr class="full"><td>Full platform · all 4</td><td><span class="num">$3,000</span></td><td><span class="num">$1,199</span><small>/mo</small></td><td><span class="num">$999</span><small>/mo</small></td></tr>
  </table>
  <p class="fine">30-day free trial on every plan · No contracts, no cancellation fees · Annual billing saves two months · Multiple locations? Ask about group pricing.</p>
</div>
