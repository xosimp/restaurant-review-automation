                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        ForEach(window.byPlatform) { platform in
                            HStack {
                                ...
                                Spacer()
                                (Text("\(platform.posts)").font(.cavnarNumber(14, weight: 700))
                                    + Text(" posts · ")
                                    + Text("\(platform.reach)").font(.cavnarNumber(14, weight: 700))
                                    + Text(" reach · ")
                                    + Text("\(platform.engagementRate)%").font(.cavnarNumber(14, weight: 700)))
                                    .font(.cavnarBody(14))
                                    .foregroundStyle(Color.cavnarInk3)
                            }
                        }
