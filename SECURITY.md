...
| `ADMIN_REQUIRE_2FA` | default `1` | `0` lets an admin without two-factor into `/admin` |
...
- 2FA: email/SMS OTP hashed at rest, backup codes, 30-day trusted devices, revocable. **Admins must have it on** (`auth._admin_two_factor_missing`).
